    ...
    <body leftmargin=180px topmargin =50px   backgroud=red>
        ...
        <form action="" method="POST">
            <table align="center" border="1"style="position:absolute;left:58px;top:50px;">
                <tr><td align="center" colspan="9">会员管理<input type="hidden" name="userId" value="<%=user.getUserId()%>"/></td></tr>
                <tr>
                    <td>ID</td>
                    <td>用户名</td>
                    <td>密码</td>
                ...
                <tr>
                <td align="center" colspan="9"><input type="submit" name="action" value="delete"/></td>
                </tr>
            </table>
            </form>
        </div>
